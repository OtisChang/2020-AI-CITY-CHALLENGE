...
parser.add_argument('--data_path', default="D:/environments/AI_city_reID_py36/AICity-track2-Re-id-csmvl310/AIC20_ReID", help='path of dataset')
parser.add_argument('--mode', default='train', choices=['train', 'evaluate', 'vis', 'aicity'], help='train or evaluate ')
